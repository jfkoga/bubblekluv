...
// Agregar controles de cámara usando OrbitControls
const controls = new OrbitControls(camera, renderer.domElement);
controls.enableDamping = true; // Amortiguación para suavizar movimientos
controls.dampingFactor = 0.05; // Ajustar amortiguación
controls.enableZoom = true;    // Habilitar zoom con el ratón
